...

{
  ...
  fileSystems."/" = {
    device = "/dev/disk/by-uuid/6eaf6c97-6d88-42ae-8886-ff06477e407d";
    fsType = "ext4";
  };

  fileSystems."/boot" = {
    device = "/dev/disk/by-uuid/E318-36C4";
    fsType = "vfat";
    options = [
      "fmask=0077"
      "dmask=0077"
  ...
  swapDevices = [
    { device = "/dev/disk/by-uuid/cf8e9686-82ab-4794-8557-fc083f1462a5"; }
  ];
